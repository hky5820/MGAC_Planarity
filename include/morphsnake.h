...
public:
	...
	//cv::Mat morphological_geodesic_active_contour(const cv::Mat & inv_edge_map, const cv::Mat & canny, const cv::Mat & init_ls,	int iterations,	int smoothing, int ballon);
